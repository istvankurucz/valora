import GroupTransactionHeader from "@/src/features/group/components/layout/GroupTransactionHeader";
	...
	return (
		<TransactionProvider>
			<Stack
				screenOptions={{
					header: ({ options }) => (
						<GroupTransactionHeader title={options.title} mainModalRef={mainModalRef} />
					),
				}}
			>
...
export default GroupTransactionLayout;

import AccountTransactionHeader from "@/src/features/account/components/layout/AccountTransactionHeader";
...
const AccountTransactionLayout = () => {
	// #region Refs
	...
	return (
		<TransactionProvider>
			<Stack
				screenOptions={{
					header: ({ options }) => (
						<AccountTransactionHeader title={options.title} mainModalRef={mainModalRef} />
					),
				}}
			>
...
export default AccountTransactionLayout;

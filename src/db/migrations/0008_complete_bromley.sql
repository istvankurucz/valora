...
INSERT INTO `__new_transaction`("id", "type", "label", "note", "category_id", "timestamp", "amount", "recurring", "account_id", "user_id", "group_id") SELECT "id", "type", "label", "note", "category_id", "timestamp", "amount", "recurring", "account_id", "user_id", "group_id" FROM `transaction`;--> statement-breakpoint
